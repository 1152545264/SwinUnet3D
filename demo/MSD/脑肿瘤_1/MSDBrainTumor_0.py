...
#             Spacingd(keys=['image', 'seg'], pixdim=cfg.Spacing, mode=['bilinear', 'nearest']),
#             Orientationd(keys=['image', 'seg'], axcodes='RAS'),
#             RandSpatialCropd(keys=['image', 'seg'], roi_size=cfg.RoiSize, random_size=False),
#             SpatialPadd(keys=['image', 'label'], spatial_size=cfg.RoiSize),
